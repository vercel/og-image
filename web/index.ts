...
const Dropdown = ({ options, value, oninput, small }: DropdownProps) => {
      ...
      H(
        ...
        H(Field, {
          ...
          input: H(Dropdown, {
            ...
            value: fileType,
            oninput: (val: FileType) => setLoadingState({ fileType: val }),
          }),
        }),
        H(Field, {
          label: "Font Size",
          input: H(Dropdown, {
            ...
            value: fontSize,
            oninput: (val: string) => setLoadingState({ fontSize: val }),
          }),
        }),
        H(Field, {
          label: "Kicker",
